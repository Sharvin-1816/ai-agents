      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-4 flex flex-col gap-4">
          <section aria-labelledby="page-title">
            <h1 id="page-title" className="mt-2 text-3xl font-extrabold text-foreground text-balance">
              Agents Dashboard
            </h1>
            <p className="text-sm text-muted-foreground mt-1">Overview of your agent performance and call history</p>
          </section>

          {/* Performance Metrics */}
          <section aria-labelledby="metrics-title" className="space-y-3">
            <h2 id="metrics-title" className="flex items-center gap-2 mt-2 font-bold">
              <span aria-hidden className="grid place-items-center">
                <Gauge size={18} />
              </span>
              Performance Metrics
            ...
            <div className="grid grid-cols-12 gap-4" role="list">
              <div className="col-span-12 md:col-span-6 xl:col-span-3" role="listitem">
                <MetricCard
              ...
              <div className="col-span-12 md:col-span-6 xl:col-span-3" role="listitem">
                <MetricCard title="Total Qualified" value="0" subtitle="Qualified prospects" icon={<TargetIcon />} />
              </div>
              <div className="col-span-12 md:col-span-6 xl:col-span-3" role="listitem">
                <MetricCard title="Total Duration" value="0.0s" subtitle="Total call time" icon={<Timer size={16} />} />
              </div>
              <div className="col-span-12 md:col-span-6 xl:col-span-3" role="listitem">
                <MetricCard
                  title="Total Cost"
              ...
              <div className="col-span-12 md:col-span-6 xl:col-span-6" role="listitem">
                <MetricCard title="Avg Rating" value="0.0" subtitle="Average call rating" icon={<Star size={16} />} />
              </div>
              <div className="col-span-12 md:col-span-6 xl:col-span-6" role="listitem">
                <MetricCard
          ...
          <section aria-labelledby="history-title" className="space-y-3">
            <h2 id="history-title" className="flex items-center gap-2 mt-2 font-bold">
              <span aria-hidden className="grid place-items-center">
                <History size={18} />
              </span>
              Call History
            ...
            <div className="grid gap-4 md:grid-cols-3 text-center text-sm text-zinc-400">
              <div>
                <strong className="block text-foreground">Download records</strong>
                <div>Export call data</div>
              </div>
              <div>
                <strong className="block text-foreground">Conversation transcripts</strong>
                <div>Full chat history</div>
              </div>
              <div>
                <strong className="block text-foreground">Performance analytics</strong>
