    ...
    <div className="min-h-svh bg-black text-zinc-100 flex">
      ...
      >
        ...
        <NavItem icon={<PlusSquare size={18} />} label="Create agents" to="/createagent" />
          ...
          <NavItem icon={<Building2 size={18} />} label="Batches" to="/batches" active/>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 p-3 md:p-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6 md:mb-8">
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-white mb-2">Agent Batches</h1>
              <p className="text-sm md:text-base text-zinc-400">Displays all batches from agents</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <div className="flex items-center gap-2 text-sm">
                <span className="text-zinc-400">Download a template sheet:</span>
          ...
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="text-center">
              <svg className="mx-auto w-16 h-16 text-zinc-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
              </svg>
              <p className="text-zinc-400 text-base md:text-lg">Select an agent to view its batches.</p>
            </div>
          </div>
